...
import { AUTH_ENDPOINTS, EMPLOYEE_ENDPOINTS, PERMISSION_ENDPOINTS, ROLE_ENDPOINTS } from './endpoints.js';
...
export { AUTH_ENDPOINTS, EMPLOYEE_ENDPOINTS, PERMISSION_ENDPOINTS, ROLE_ENDPOINTS };
export default api;
