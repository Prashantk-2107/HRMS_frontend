...
const RolesHeader = ({ onCreateClick }) => {
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 text-left">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Departments & Roles</h1>
        <p className="text-sm text-slate-500">Configure department-based access controls and module permissions.</p>
      </div>
